...
public class ListAdapter_AllocationlList extends BaseAdapter {

    public static final String TAG = ListAdapter_AllocationlList.class.getSimpleName();

    private Context mContext;
    private List<AllocationModel> allocationList;
    private LayoutInflater mInflater;

    public ListAdapter_AllocationlList(Context context) {
        mContext = context;
